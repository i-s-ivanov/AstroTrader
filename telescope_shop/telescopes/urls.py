...
from telescope_shop.telescopes.views import TelescopeListView, TelescopeDetails, TelescopeCreateView, \
    TelescopeUpdateView, TelescopeDeleteView, CommentView
...
urlpatterns = [
    ...
    path('details/<int:pk>/comment/', CommentView.as_view(), name='comment'),
